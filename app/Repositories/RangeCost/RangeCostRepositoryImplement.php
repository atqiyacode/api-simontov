...
namespace App\Repositories\RangeCost;

use LaravelEasyRepository\Implementations\Eloquent;
use App\Models\RangeCost;

class RangeCostRepositoryImplement extends Eloquent implements RangeCostRepository
{
    ...
    public function __construct(RangeCost $model)
    {
        $this->model = $model;
    }
    ...
    {
        return $this->model->canDelete()->with(['rangeType'])->useFilters()->get();
    }

    public function getPaginate()
    {
        return $this->model->canDelete()->with(['rangeType'])->useFilters()->dynamicPaginate();
    }
