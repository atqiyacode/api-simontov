...
namespace App\Repositories\DashboardChart;
...
class DashboardChartRepositoryImplement extends Eloquent implements DashboardChartRepository
{
    ...
    public function __construct(DashboardChart $model)
    {
        $this->model = $model;
    }
    ...
    {
        return $this->model->canDelete()->with(['users'])->useFilters()->get();
    }

    public function getPaginate()
    {
        return $this->model->canDelete()->with(['users'])->useFilters()->dynamicPaginate();
    }

    public function findById($id)
    {
        return $this->model->canDelete()->with(['users'])->findOrFail($id);
    }
