...
namespace App\Repositories\RangeType;
...
class RangeTypeRepositoryImplement extends Eloquent implements RangeTypeRepository
{
    ...
    public function __construct(RangeType $model)
    {
        $this->model = $model;
    }
