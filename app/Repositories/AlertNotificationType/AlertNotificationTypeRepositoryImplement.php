...
class AlertNotificationTypeRepositoryImplement extends Eloquent implements AlertNotificationTypeRepository
{
    ...
    public function __construct(AlertNotificationType $model)
    {
        $this->model = $model;
    }
