...
class PermissionRepositoryImplement extends Eloquent implements PermissionRepository
{
    ...
    {
        return $this->model->with(['roles'])->canDelete()->useFilters()->get();
    }

    public function getPaginate()
    {
        return $this->model->with(['roles'])->canDelete()->useFilters()->dynamicPaginate();
    }

    public function findById($id)
    {
        return $this->model->with(['roles'])->canDelete()->useFilters()->findOrFail($id);
    }
