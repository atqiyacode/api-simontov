...
namespace App\Services\StatusAlarm;

use App\Http\Resources\StatusAlarm\StatusAlarmResource;
use LaravelEasyRepository\ServiceApi;
use Illuminate\Support\Facades\DB;
use App\Repositories\StatusAlarm\StatusAlarmRepository;

class StatusAlarmServiceImplement extends ServiceApi implements StatusAlarmService
{
    ...
    public function __construct(StatusAlarmRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage($this->found_message)
            ->setStatus(true)
            ->setCode(200)
            ->setResult(StatusAlarmResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage($this->found_message)
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new StatusAlarmResource($response));
    }
