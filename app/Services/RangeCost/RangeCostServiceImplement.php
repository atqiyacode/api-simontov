...
namespace App\Services\RangeCost;

use App\Http\Resources\RangeCost\RangeCostResource;
use LaravelEasyRepository\ServiceApi;
use Illuminate\Support\Facades\DB;
use App\Repositories\RangeCost\RangeCostRepository;

class RangeCostServiceImplement extends ServiceApi implements RangeCostService
{
    ...
    public function __construct(RangeCostRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage($this->found_message)
            ->setStatus(true)
            ->setCode(200)
            ->setResult(RangeCostResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage($this->found_message)
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new RangeCostResource($response));
    }
