...
namespace App\Services\RangeType;

use App\Http\Resources\RangeType\RangeTypeResource;
use LaravelEasyRepository\ServiceApi;
use Illuminate\Support\Facades\DB;
use App\Repositories\RangeType\RangeTypeRepository;

class RangeTypeServiceImplement extends ServiceApi implements RangeTypeService
{
    ...
    public function __construct(RangeTypeRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage($this->found_message)
            ->setStatus(true)
            ->setCode(200)
            ->setResult(RangeTypeResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage($this->found_message)
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new RangeTypeResource($response));
    }
