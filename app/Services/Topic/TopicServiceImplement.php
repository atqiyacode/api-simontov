...
class TopicServiceImplement extends ServiceApi implements TopicService
{
    ...
    public function __construct(TopicRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage($this->found_message)
            ->setStatus(true)
            ->setCode(200)
            ->setResult(TopicResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage($this->found_message)
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new TopicResource($response));
    }
