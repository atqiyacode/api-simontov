...
namespace App\Services\DashboardChart;

use App\Http\Resources\DashboardChart\DashboardChartResource;
use LaravelEasyRepository\ServiceApi;
use Illuminate\Support\Facades\DB;
use App\Repositories\DashboardChart\DashboardChartRepository;

class DashboardChartServiceImplement extends ServiceApi implements DashboardChartService
{
    ...
    public function __construct(DashboardChartRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(DashboardChartResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new DashboardChartResource($response));
    }
