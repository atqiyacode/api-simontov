...
use App\Repositories\LocationNotification\LocationNotificationRepository;

class LocationNotificationServiceImplement extends ServiceApi implements LocationNotificationService
{
    ...
    public function __construct(LocationNotificationRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(LocationNotificationResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new LocationNotificationResource($response));
    }
    ...
    {
        $response = $this->mainRepository->countByLocation($locationId);
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult($response);
