...
namespace App\Services\AlertNotificationType;

use App\Http\Resources\AlertNotificationType\AlertNotificationTypeResource;
use LaravelEasyRepository\ServiceApi;
use Illuminate\Support\Facades\DB;
use App\Repositories\AlertNotificationType\AlertNotificationTypeRepository;

class AlertNotificationTypeServiceImplement extends ServiceApi implements AlertNotificationTypeService
{
    ...
    public function __construct(AlertNotificationTypeRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(AlertNotificationTypeResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new AlertNotificationTypeResource($response));
    }
